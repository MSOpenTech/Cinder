...
basicAppXAMLMain::~basicAppXAMLMain()
{
...
void basicAppXAMLMain::CreateWindowSizeDependentResources() 
{
	// TODO: Replace this with the size-dependent initialization of your app's content.
	m_sceneRenderer->CreateWindowSizeDependentResources();
}

void basicAppXAMLMain::StartRenderLoop()
{
...
void basicAppXAMLMain::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

// Updates the application state once per frame.
void basicAppXAMLMain::Update() 
{
	ProcessInput();
