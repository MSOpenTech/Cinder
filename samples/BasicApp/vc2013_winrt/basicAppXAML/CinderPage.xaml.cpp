	...
	m_coreInput(nullptr)
{
    ...
    // nb. it is create as the global ::app in the macro CINDER_APP_BASIC
    // zv7
    //	m_main = std::unique_ptr<cinder::app::CinderMain>(new cinder::app::CinderMain(m_deviceResources));
    m_main = ::app;
