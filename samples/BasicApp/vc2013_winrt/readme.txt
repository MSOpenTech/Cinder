Notes for BasicApp using Cinder adapted to XAML as of 1/23/2014

This project allows the developer to create a Cinder application that runs inside a
...
1/23/2014	Dave R		bug fix in CinderMain added to template, template updated
						template not used due to bug with Assets

Usage:

1.	Replace the file "basicAppDX.cpp" with your own Cinder application, following the usual the 	
	Cinder coding guidelines.

2.	Clean and build the solution.

Information:

*   If needed, the XAML content can be modified in the "Cinder XAML App pages", however "CinderPage" 
