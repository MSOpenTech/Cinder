...
// from: http://msdn.microsoft.com/en-us/library/jj872764.aspx
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void AddRemoveEffect_Checked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                await mediaCapture.AddEffectAsync(MediaStreamType.Photo, "CaptureMediaExtension.CaptureEffect", null);
