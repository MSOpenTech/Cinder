// CaptureMediaExtension.cpp : Defines the exported functions for the DLL application.
//
...
class CCapture
    ...
    IMFTransform>
{
    InspectableClass(RuntimeClass_CaptureTransform_CaptureEffect, BaseTrust)
